...
import com.example.conversy.multitouch.statemachines.DragMachine;
import com.example.conversy.multitouch.statemachines.MainMachine;
import com.example.conversy.multitouch.statemachines.PressureMachine;
...
public class T01_MTCursor extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		haptics = (Vibrator) this.getSystemService(VIBRATOR_MANAGER_SERVICE);
	}
	...
	public class MyView extends View {
		...
		public MyView(final Context c) {
			...
			for (int i = 0; i < nbFigures; i++) {
				...
				StateMachine machine = new PressureMachine(graphicItem, this.getContext());
